        ...
        <>
            <div className="card border border-secondary eachitem h-100">
                ...
                <div className="card-body">
                    ...
                    <h6 className="card-subtitle mb-2 text-muted font-wright-bold">Category: <button className='p-2 rounded bg-danger text-white border border-dark'> {item.Category}</button></h6>
